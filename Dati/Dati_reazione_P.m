...
global fp_discreto vertici_mesh u_discreto
% Source term
data.force = @(x,y,t,param) stimatore_dist(x,y,fp_discreto,vertici_mesh);
...
% reaction
data.reaction = @(x,y,t,param)  stimatore_dist(x,y,u_discreto,vertici_mesh);
