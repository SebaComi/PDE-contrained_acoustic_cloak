function [out] = IPOPT_genera_grad(input,DATA,MESH,model,costo,gradiente)

V = input(1:end/2);
U = input(end/2+1:end);

A_0 = model.A_0;    A_j = model.A_j;    A_j_conc = model.A_j_conc;
B_0 = model.B_0;    B_j = model.B_j;    B_j_conc = model.B_j_conc;
C = model.C;        D = model.D;        E = model.E;
F = model.F;        M_D_a = model.M_D_a; lunghezze = model.lunghezze;
lmb_u = model.lmb_u;        lmb_v = model.lmb_v;
